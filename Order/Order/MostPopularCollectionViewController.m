...
- (NSArray *)dealsArr {
    if (_dealsArr == nil) {
        ...
        model6.headImage = @"detail_img1";
        model6.title = @"Designer's Desk";
        model6.detailsTitle = @"Perfect your home office.";
        model6.price = @"$324.95";
        _dealsArr = @[model1, model2, model3, model5, model4, model6];
    }
